...
class LessonTests(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        # Создаем курс
        self.course = Course.objects.create(name="Test Course", description="Test Description", owner=self.admin_user)
    ...
    def test_create_lesson(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)  # Проверка на успешное создание
    ...
    def test_retrieve_lesson(self):
        ...
        response = self.client.get(reverse('materials:lesson_retrieve', args=[self.lesson.id]))
...
class SubscriptionViewTests(APITestCase):
    ...
    def test_remove_subscription(self):
        ...
        Subscription.objects.create(user=self.user, course=self.course)  # Сначала создаем подписку
