...
class Course(models.Model):
    ...
    preview = models.ImageField(
        upload_to="courses/previews/", null=True, blank=True, verbose_name="Картинка"
    )
...
class Lesson(models.Model):
    ...
    preview = models.ImageField(
        upload_to="lessons/previews/", null=True, blank=True, verbose_name="Превью"
    )
