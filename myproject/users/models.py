...
class Payment(models.Model):
    ...
    session_id = models.CharField(max_length=512, null=True, blank=True, verbose_name="ID сессии")
    payment_link = models.URLField(max_length=512,null=True, blank=True, verbose_name="Ссылка на оплату")
